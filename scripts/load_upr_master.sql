...
================================================================================
  ...
  CROSS-DATABASE SOURCES (DHCA standard 3-part names):
  ...
  SSMS may show red IntelliSense underlines on these — safe to ignore if VPN is up;
  they are editor warnings only, not runtime errors.
================================================================================
*/
USE UPRDB_Test;
GO
